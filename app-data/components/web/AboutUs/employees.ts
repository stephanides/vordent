...
export const employees: Employees = [
  {
    name: 'MDDr. Richard Vorobeľ',
    photo: '/images/our-team/employees/richard.png',
    detailPhoto: '/images/our-team/employees/richard_detail.png',
    position: 'Chirurg-implantológ',
    description:
      'MDDr. Richard Vorobeľ ukončil štúdium na Lekárskej fakulte Univerzity P. J. Šafárika v Košiciach, odbor stomatológia v roku 2014. Od roku 2017 si rozšíril odbornú spôsobilosť na výkon dentoalveolárnej chirurgie. V súčasnosti sa špecializuje na implantológiu a chirurgickú stomatológiu. Pravidelne absolvuje množstvo odborných školení, seminárov a kongresov a so svojim profesionálnym tímom pracuje už na dvoch klinikách v Poprade.',
    category: 'doctor',
  },
  {
